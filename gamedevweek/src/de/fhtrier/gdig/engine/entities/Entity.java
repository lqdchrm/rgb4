...
public class Entity implements Identifiable
{
	...
	public Entity(final int id)
	{
		...
		// network
		this.networkData = this._createNetworkData();
	...
	// Patrick Wurde hinzugefügt Damit die Kolisionene gehandelt werden könne
	// von dem Objekt
	/**
	 * Handeld die Collisionene mit anderen {@link CollidableEntity}'s
	 */
