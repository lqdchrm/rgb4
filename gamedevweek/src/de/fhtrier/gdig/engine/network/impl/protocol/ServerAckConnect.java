...
/**
 * This command is send by the server to a client as answer to a ClientQueryConnect-command.
 * It contains the networkId, which the client should take as identifier
 */
