...
public class ClientPlayingState extends PlayingState {
	...
	// Transitions for switching to menu
	private FadeInTransition fadeTransitionIn = new FadeInTransition();
	private FadeOutTransition fadeTransitionOut = new FadeOutTransition();
