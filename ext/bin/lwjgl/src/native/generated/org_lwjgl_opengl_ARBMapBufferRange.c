...
JNIEXPORT jobject JNICALL Java_org_lwjgl_opengl_ARBMapBufferRange_nglMapBufferRange(JNIEnv *env, jclass clazz, jint target, jlong offset, jlong length, jint access, jobject old_buffer, jlong function_pointer) {
