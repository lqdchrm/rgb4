...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL20_nglShaderSource3(JNIEnv *env, jclass clazz, jint shader, jint count, jobject strings, jint strings_position, jobject length, jint length_position, jlong function_pointer) {
