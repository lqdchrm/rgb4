...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL32_nglDrawElementsBaseVertex(JNIEnv *env, jclass clazz, jint mode, jint count, jint type, jobject indices, jint indices_position, jint basevertex, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL32_nglDrawRangeElementsBaseVertex(JNIEnv *env, jclass clazz, jint mode, jint start, jint end, jint count, jint type, jobject indices, jint indices_position, jint basevertex, jlong function_pointer) {
	const GLvoid *indices_address = ((const GLvoid *)(((char *)(*env)->GetDirectBufferAddress(env, indices)) + indices_position));
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL32_nglDrawElementsInstancedBaseVertex(JNIEnv *env, jclass clazz, jint mode, jint count, jint type, jobject indices, jint indices_position, jint primcount, jint basevertex, jlong function_pointer) {
	const GLvoid *indices_address = ((const GLvoid *)(((char *)(*env)->GetDirectBufferAddress(env, indices)) + indices_position));
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL32_nglGetMultisamplefv(JNIEnv *env, jclass clazz, jint pname, jint index, jobject val, jint val_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL32_nglFramebufferTextureLayer(JNIEnv *env, jclass clazz, jint target, jint attachment, jint texture, jint level, jint layer, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL32_nglGetInteger64v(JNIEnv *env, jclass clazz, jint pname, jobject data, jint data_position, jlong function_pointer) {
	GLint64 *data_address = ((GLint64 *)(*env)->GetDirectBufferAddress(env, data)) + data_position;
	glGetInteger64vPROC glGetInteger64v = (glGetInteger64vPROC)((intptr_t)function_pointer);
	glGetInteger64v(pname, data_address);
}

JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL32_nglGetInteger64i_v(JNIEnv *env, jclass clazz, jint value, jint index, jobject data, jint data_position, jlong function_pointer) {
	GLint64 *data_address = ((GLint64 *)(*env)->GetDirectBufferAddress(env, data)) + data_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL32_nglGetSynciv(JNIEnv *env, jclass clazz, jlong sync, jint pname, jint bufSize, jobject length, jint length_position, jobject values, jint values_position, jlong function_pointer) {
