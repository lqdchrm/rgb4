...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_EXTVertexAttrib64bit_nglVertexAttribL1dvEXT(JNIEnv *env, jclass clazz, jint index, jobject v, jint v_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_EXTVertexAttrib64bit_nglVertexAttribL2dvEXT(JNIEnv *env, jclass clazz, jint index, jobject v, jint v_position, jlong function_pointer) {
	const GLdouble *v_address = ((const GLdouble *)(*env)->GetDirectBufferAddress(env, v)) + v_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_EXTVertexAttrib64bit_nglVertexAttribL3dvEXT(JNIEnv *env, jclass clazz, jint index, jobject v, jint v_position, jlong function_pointer) {
	const GLdouble *v_address = ((const GLdouble *)(*env)->GetDirectBufferAddress(env, v)) + v_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_EXTVertexAttrib64bit_nglVertexAttribL4dvEXT(JNIEnv *env, jclass clazz, jint index, jobject v, jint v_position, jlong function_pointer) {
	const GLdouble *v_address = ((const GLdouble *)(*env)->GetDirectBufferAddress(env, v)) + v_position;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_EXTVertexAttrib64bit_nglVertexAttribLPointerEXT(JNIEnv *env, jclass clazz, jint index, jint size, jint type, jint stride, jobject pointer, jint pointer_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_EXTVertexAttrib64bit_nglGetVertexAttribLdvEXT(JNIEnv *env, jclass clazz, jint index, jint pname, jobject params, jint params_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_EXTVertexAttrib64bit_nglVertexArrayVertexAttribLOffsetEXT(JNIEnv *env, jclass clazz, jint vaobj, jint buffer, jint index, jint size, jint type, jint stride, jlong offset, jlong function_pointer) {
