...
public class Assets
{
	...
	public static final int PlayerIdleAnimId = 111;
	public static final int PlayerRunAnimId = 112;
	public static final int PlayerJumpAnimId = 113;

	public static final String PlayerRunAnimImagePath = "sprites/player/laufen_128_128_20.png";
