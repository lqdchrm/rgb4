...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL30_nglClearBufferfv(JNIEnv *env, jclass clazz, jint buffer, jint drawbuffer, jobject value, jint value_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL30_nglClearBufferiv(JNIEnv *env, jclass clazz, jint buffer, jint drawbuffer, jobject value, jint value_position, jlong function_pointer) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GL30_nglClearBufferuiv(JNIEnv *env, jclass clazz, jint buffer, jint drawbuffer, jobject value, jint value_position, jlong function_pointer) {
	const GLint *value_address = ((const GLint *)(*env)->GetDirectBufferAddress(env, value)) + value_position;
