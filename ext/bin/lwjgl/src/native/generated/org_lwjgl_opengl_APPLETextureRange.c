...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_APPLETextureRange_nglTextureRangeAPPLE(JNIEnv *env, jclass clazz, jint target, jint length, jobject pointer, jint pointer_position, jlong function_pointer) {
